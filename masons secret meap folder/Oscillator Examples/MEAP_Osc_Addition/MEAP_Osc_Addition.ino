...
void setup(){
  ...
  osc1.setFreq(880); //set frequency of sine oscillator
}
...
void updateControl(){
  ...
  osc1.setFreq((float)map(potVals[0], 0, 4095, 100, 1000));
  osc2.setFreq((float)map(potVals[1], 0, 4095, 100, 1000));
...
int updateAudio(){
  ...
  return MonoOutput::fromAlmostNBit(9, osc1Val + osc2Val);
}
