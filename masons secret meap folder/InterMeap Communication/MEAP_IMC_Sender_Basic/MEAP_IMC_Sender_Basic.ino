...
void updateControl(){
  ...
  if(noteClock.ready()){
    sendImc(0); // send imc clock pulse on channel 0
    noteClock.start(1000);
  }
...
void sendImc(int channelNum){
  switch(channelNum){
    case 0:
      imc0Val = 1;
      digitalWrite(imc0Pin, HIGH);
      imc0Delay.start(50);
      break;
    case 1:
      imc1Val = 1;
      digitalWrite(imc1Pin, HIGH);
      imc1Delay.start(50);
      break;
  }
}
