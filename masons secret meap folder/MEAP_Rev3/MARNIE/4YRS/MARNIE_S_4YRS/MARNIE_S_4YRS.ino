...
void updateControl() {
  ...
  // MARNIE Pot Controls
  cutoff = map(meap.auxMuxVals[4], 0, 4095, 0, 255);
  filter.setCutoffFreq(cutoff);
  ...
  switch (number) {
    case 0:
      if (pressed) {  // Pad 1 pressed
        if (patterns[curr_pattern_bank][0].active) {
          patterns[curr_pattern_bank][0].stop();
        } else {
          patterns[curr_pattern_bank][0].start();
        }
      } else {  // Pad 1 released
      }
      break;
    case 1:
      if (pressed) {  // Pad 2 pressed
        if (patterns[curr_pattern_bank][1].active) {
          patterns[curr_pattern_bank][1].stop();
        } else {
          patterns[curr_pattern_bank][1].start();
        }
      } else {  // Pad 2 released
      }
      break;
    case 2:
      if (pressed) {  // Pad 3 pressed
        if (patterns[curr_pattern_bank][2].active) {
          patterns[curr_pattern_bank][2].stop();
        } else {
          patterns[curr_pattern_bank][2].start();
        }
      } else {  // Pad 3 released
      }
      break;
    case 3:
      if (pressed) {  // Pad 4 pressed
        if (patterns[curr_pattern_bank][3].active) {
          patterns[curr_pattern_bank][3].stop();
        } else {
          patterns[curr_pattern_bank][3].start();
        }
      } else {  // Pad 4 released
      }
      break;
    case 4:
      if (pressed) {  // Pad 5 pressed
        if (patterns[curr_pattern_bank][4].active) {
          patterns[curr_pattern_bank][4].stop();
        } else {
          patterns[curr_pattern_bank][4].start();
        }
      } else {  // Pad 5 released
      }
      break;
    case 5:
      if (pressed) {  // Pad 6 pressed
        if (patterns[curr_pattern_bank][5].active) {
          patterns[curr_pattern_bank][5].stop();
        } else {
          patterns[curr_pattern_bank][5].start();
        }
      } else {  // Pad 6 released
      }
      break;
    case 6:
      if (pressed) {  // Pad 7 pressed
        if (patterns[curr_pattern_bank][6].active) {
          patterns[curr_pattern_bank][6].stop();
        } else {
          patterns[curr_pattern_bank][6].start();
        }
      } else {  // Pad 7 released
      }
      break;
    case 7:
      if (pressed) {  // Pad 8 pressed
        if (patterns[curr_pattern_bank][7].active) {
          patterns[curr_pattern_bank][7].stop();
        } else {
          patterns[curr_pattern_bank][7].start();
        }
      } else {  // Pad 8 released
      }
      break;
