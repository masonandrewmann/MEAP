...
void updateControl() {
  ...
  voice.op[0].setAttackTime(map(meap.aux_mux_vals[6]>>4, 0, 255, 1, 3000));
  voice.op[0].setReleaseTime(map(meap.aux_mux_vals[5]>>4, 0, 255, 1, 3000));

  voice.op[1].setAttackTime(map(meap.aux_mux_vals[4]>>4, 0, 255, 1, 3000));
  voice.op[1].setReleaseTime(map(meap.aux_mux_vals[3]>>4, 0, 255, 1, 3000));

  voice.op[2].setAttackTime(map(meap.aux_mux_vals[0]>>4, 0, 255, 1, 3000));
  voice.op[2].setReleaseTime(map(meap.aux_mux_vals[1]>>4, 0, 255, 1, 3000));

  voice.op[3].setAttackTime(2000);
  voice.op[3].setReleaseTime(2000);


  voice.op[0].setGain(255);
  voice.op[1].setGain(meap.pot_vals[1] >> 4);
  voice.op[2].setGain(meap.pot_vals[0] >> 4);
  voice.op[3].setGain(meap.aux_mux_vals[2] >> 4);
