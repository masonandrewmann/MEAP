...
public:
  ...
  bool port_done;         /**< True when portamento is done, False while portamento is sliding to newfe note */
...
AudioOutput_t updateAudio() {
  ...
  // //send output to DAC
  // output_bits--;
  return StereoOutput::fromAlmostNBit(output_bits-3, l_sample, l_sample);
}
  ...
  if (channel == MIDI_PAD_CHANNEL) {  // HANDLING PADS FRROM MIDI KEYBOARD
    switch (note) {
      ...
      case 49:
        ...
        break;
      case 36:
        noteOnHandler(48, 127, MIDI_NOTE_CHANNEL, 27);  // note vel channel override ---- NOTE THAT IF RELEASE IS DOWN THIS NOTE WILL NOT SOUND BECAUSE NOTE OFF IS SO SOON
        noteOffHandler(48, MIDI_NOTE_CHANNEL);  // note channel
        break;
    }
  }
}
