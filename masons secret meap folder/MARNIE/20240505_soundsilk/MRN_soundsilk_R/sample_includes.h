...
cmaj_reverb_DATA, // 23 - Cmaj_reverb
pistachio_sine_DATA, // 24 pistachio_sine
rebirth1_DATA, // 25 mel vocal sample 1
rebirth2_DATA, // 26 mel vocal sample 2
ion_kick_DATA, // 27 yabujin kick
ep2_DATA, // 28 ep2
fm_DATA, // 29 fm
glass_DATA, // 30 glass
harp3_DATA, // 31 harp3
...
pad1_DATA, // 34 pad1
pad2_DATA, // 35 pad2
arp_steady_DATA, // 36 arpsteady
rhodes_DATA, // 37 rhodes
riley_DATA, // 38 riley
samu_DATA, // 39 samu
space_DATA, //40 space
tone_DATA, // 41 tone
...
cmaj_reverb_NUM_CELLS, // 23 - cmaj_reverb
pistachio_sine_NUM_CELLS, // 24 pistachio_sine
rebirth1_NUM_CELLS, // 25 mel vocal sample 1
rebirth2_NUM_CELLS, // 26 mel vocal sample 2
ion_kick_NUM_CELLS, // yabujin kick
ep2_NUM_CELLS, // 28 ep2
fm_NUM_CELLS, // 29 fm
glass_NUM_CELLS, // 30 glass
harp3_NUM_CELLS, // 31 harp3
harp4_NUM_CELLS, // 32 harp4
lemon_NUM_CELLS, // 33 lemon
pad1_NUM_CELLS, // 34 pad1
pad2_NUM_CELLS, // 35 pad2
arp_steady_NUM_CELLS, // 36 arpsteady
rhodes_NUM_CELLS, // 37 rhodes
riley_NUM_CELLS, // 38 riley
samu_NUM_CELLS, // 39 samu
space_NUM_CELLS, //40 space
tone_NUM_CELLS, // 41 tone
vince_NUM_CELLS // 42 vince
};