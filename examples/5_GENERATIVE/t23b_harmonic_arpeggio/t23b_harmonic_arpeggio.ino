/*
  Laurie Spiegel harmonic algorithm program modified to arpeggiate the chords
 */

#define CONTROL_RATE 128  // Hz, powers of 2 are most reliable
#include <Meap.h>         // MEAP library, includes all dependent libraries, including all Mozzi modules

Meap<mMEAP4B> meap;                                            // creates MEAP object to handle inputs and other MEAP library functions
