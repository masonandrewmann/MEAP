...
void updateControl()
{
  ...
  if (chord_timer.ready())
  {
    ...
    if (tree_level != 0)
    { // move one level down tree
      tree_level = tree_level - 1;
    }
    else
    { // if at bottom of tree (0), jump to a random level
    ...
    case 3: // twigs: I or vi
      ...
      {                 // 25% chance of I, 75% chance of vi
    ...
    case 2: // branches: IV or ii
      if (meap.irand(1, 100) > 33)
      {                 // 66% change of IV, 33% chance of ii
    ...
    case 1: // boughs: V or vii˚
      if (meap.irand(1, 100) > 25)
      {                 // 75% change of V, 25% chance of vii˚
    ...
    case 0: // trunk: I or vi
      if (meap.irand(1, 100) > 25)
      {                 // 75% change of I, 25% chance of vi
        chord_root = 0; // I chord (C major)
      }
      else
      {
