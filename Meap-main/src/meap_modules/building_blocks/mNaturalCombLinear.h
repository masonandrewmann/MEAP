...
public:
    ...
    T next(T in_sample)
    {
        ...
        int32_t next_sample = (int_component + 1) % max_delay_samples_;
        // T out_sample = in_sample + frac_component * delay_buffer_[int_component + 1] + (1 - frac_component) * delay_buffer_[int_component];
        T out_sample = in_sample + delay_buffer_[int_component] + frac_component * (delay_buffer_[next_sample] - delay_buffer_[int_component]);
