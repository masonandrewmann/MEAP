...
public:
    ...
    */
    ...
    /**
     * Allows operator to function in fixed frequency mode
     * if fixed freq is set to a nonzero value, operator will always play that frequency
     * if fixed freq is set to zero, operator will function like normal in non-fixed mode
     */
