// #ifndef mSAMPLERADSRPOLY_H_
// #define mSAMPLERADSRPOLY_H_
...
// {
// public:
//     mSamplerADSR(const T *TABLE_NAME, uint64_t TABLE_SIZE, uint8_t *midi_table_name)
//     {
//         init(TABLE_NAME, TABLE_SIZE, midi_table_name);
//     };

//     mSamplermSamplerADSRPoly(const T *TABLE_NAME, uint64_t TABLE_SIZE)
//     {
...
// //  template<AUDIO_RATE, AUDIO_RATE> adsr[mPOLYPHONY];
