...
template <uint32_t mNUM_CELLS = SIN2048_NUM_CELLS, uint32_t mAUDIO_RATE = AUDIO_RATE, uint32_t mCONTROL_RATE = CONTROL_RATE, class T = int8_t, uint16_t mPOLYPHONY = 4>
class mFM4Poly
{
public:
    ...
    mFM4Voice<mNUM_CELLS, mAUDIO_RATE, mCONTROL_RATE, T> voices[mPOLYPHONY];
