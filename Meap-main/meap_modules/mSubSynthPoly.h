...
template <uint32_t mNUM_CELLS = SAW2048_NUM_CELLS, uint32_t mNUM_OSC = 3, uint32_t mAUDIO_RATE = AUDIO_RATE, uint32_t mCONTROL_RATE = CONTROL_RATE, class T = int8_t, uint16_t mPOLYPHONY = 4>
class mSubSynthPoly
{
public:
    ...
    mSubSynthVoice<mNUM_CELLS, mNUM_OSC, mAUDIO_RATE, mCONTROL_RATE, T> voices[mPOLYPHONY];
