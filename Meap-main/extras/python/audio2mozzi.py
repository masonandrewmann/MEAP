...
#
#	Usage: 
#	>>>audio2mozzi.py <infile outfile tablename samplerate>
#	
...
#   @param bit_depth      Desired output bit_depth: can only be 16 or 8
#
...
if len(sys.argv) != 6:
        print ('Usage: audio2mozzi.py <infile outfile tablename samplerate>')
        sys.exit(1)

[infile, outfile, tablename, samplerate, bit_depth] = sys.argv[1:]

def audio2mozzi(infile, outfile, tablename, samplerate, bit_depth):
...
audio2mozzi(infile, outfile, tablename, samplerate, bit_depth)
